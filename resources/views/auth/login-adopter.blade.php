...
<body>
    ...
    <div class="">
        ...
        <div class="bg-slate-700 h-screen flex justify-center">
            ...
            <div class="card bg-slate-900 mt-20 h-[500px] p-14 rounded-lg">
                <div class="card-body">
                    <form action="{{ route('login') }}" method="POST">
                        ...
                        <div class="mt-6">
                            ...
                            <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-10">
                                login
                            </button>
